...
------
RegisterNetEvent('GTA_Sound:PlayOnOne')
AddEventHandler('GTA_Sound:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
RegisterNetEvent('GTA_Sound:PlayOnAll')
AddEventHandler('GTA_Sound:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
RegisterNetEvent('GTA_Sound:PlayWithinDistance')
AddEventHandler('GTA_Sound:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
...
------
-- RegisterNetEvent LIFE_CL:Sound:PlayWithinDistanceOS (Bigmode varient of GTA_Sound:PlayWithinDistance)
--
...
-- @TODO Change sound volume based on the distance the player is away from the playOnEntity.
------
RegisterNetEvent('GTA_Sound:PlayWithinDistanceOS')
AddEventHandler('GTA_Sound:PlayWithinDistanceOS', function(playerCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(GetPlayerPed(-1))
